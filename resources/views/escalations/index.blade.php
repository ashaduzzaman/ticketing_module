...
@section('content')
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0 text-dark">Escalation Panel</h1>
            </div><!-- /.col -->
        </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                ...
                <div class="col">
                    <div class="card text-center">
                        ...
                        <div class="col-md-2 float-right">
                            <form action="{{ url('/escalation/create') }}" method="GET">
                        ...
                        <div class="card-body">
                            <table id="example" class="table table-bordered table-hover" style="width:100%">
                                ...
                                @foreach($escalations as $escalation)
                                    <tr>
                                        <td>{{ ++$sl }}</td>
                                        <td>{{ $escalation->query_type->name }}</td>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ url('/escalation', ['id' => $escalation->id]) }}" method="post" style ='float: left; padding: 5px;'>
                                                @method('delete')
                                                @csrf
                                                <button type="submit" class="btn btn-danger delete-confirm" data-name="{{ $escalation->name }}"><i class="fa fa-trash-alt"></i></button> 
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
